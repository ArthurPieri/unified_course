# 03 Hardware Check — References

- [Docker Desktop — Settings/Resources](https://docs.docker.com/desktop/settings/) — memory cap controls
- [Docker Engine install (Linux)](https://docs.docker.com/engine/install/) — native daemon
- [Docker Compose install](https://docs.docker.com/compose/install/) — v2 plugin
