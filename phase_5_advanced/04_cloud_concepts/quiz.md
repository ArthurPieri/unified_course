...
7. **B** — Egress and cross-AZ traffic are the two biggest "hidden" data-transfer bills. [AWS EC2 pricing](https://aws.amazon.com/ec2/pricing/on-demand/) · [Azure Bandwidth pricing](https://azure.microsoft.com/en-us/pricing/details/bandwidth/) · [Google Cloud Network pricing](https://cloud.google.com/vpc/network-pricing)
