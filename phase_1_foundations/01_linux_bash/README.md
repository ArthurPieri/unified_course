...
Ref: `../linux_fundamentals/course/01-linux-fundamentals.md:L168-L225` · [Linux man-pages: hier(7)](https://man7.org/linux/man-pages/man7/hier.7.html)
...
Ref: `../linux_fundamentals/course/01-linux-fundamentals.md:L652-L768` · [GNU coreutils: chmod](https://www.gnu.org/software/coreutils/manual/html_node/chmod-invocation.html)
...
Ref: `../linux_fundamentals/course/01-linux-fundamentals.md:L934-L979` · [Linux man-pages: signal(7)](https://man7.org/linux/man-pages/man7/signal.7.html) · [Docker CLI: docker stop](https://docs.docker.com/reference/cli/docker/container/stop/)
...
Ref: `../linux_fundamentals/course/01-linux-fundamentals.md:L272-L335`
...
Ref: `../linux_fundamentals/course/01-linux-fundamentals.md:L1027-L1074` · [Bash Reference Manual: Bash Startup Files](https://www.gnu.org/software/bash/manual/html_node/Bash-Startup-Files.html)
...
Ref: `../linux_fundamentals/course/01-linux-fundamentals.md:L826-L898` · [Bash Reference Manual: Redirections](https://www.gnu.org/software/bash/manual/html_node/Redirections.html) · [Bash Reference Manual: Process Substitution](https://www.gnu.org/software/bash/manual/html_node/Process-Substitution.html)
...
Ref: `../linux_fundamentals/course/01-linux-fundamentals.md:L772-L822` · [GNU grep manual](https://www.gnu.org/software/grep/manual/grep.html) · [GNU sed manual](https://www.gnu.org/software/sed/manual/sed.html) · [GNU awk manual](https://www.gnu.org/software/gawk/manual/gawk.html) · [Linux man-pages: xargs(1)](https://man7.org/linux/man-pages/man1/xargs.1.html)
...
Ref: `../linux_fundamentals/course/02-system-administration.md:L525-L621`
...
|---|---|---|---|
| `./script.sh: Permission denied` | File is not executable | `chmod +x script.sh` | `../linux_fundamentals/course/01-linux-fundamentals.md:L701-L718` |
| Script runs in one terminal, fails in another | Variable was set but not `export`ed; child process never saw it | `export VAR=value` and add to `~/.bashrc` | `../linux_fundamentals/course/01-linux-fundamentals.md:L1044-L1056` |
...
| cron job works by hand but not from crontab | cron runs with a minimal `PATH` and no shell init files | Use absolute paths; set `PATH=` at the top of the crontab | `../linux_fundamentals/course/02-system-administration.md:L525-L621` |
