...
| HMS container boot-loops `schematool` | Postgres not ready when HMS started, or volume had partial schema | Wait for `metastore-db` healthy; on a reset, `docker compose down -v` and restart | `../compose/full-stack/docker-compose.yml:L71-L98` |
